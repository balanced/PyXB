...
class TestEnumerations (unittest.TestCase):
    def testString (self):
        self.assertRaises(pyxb_123.SimpleTypeValueError, eString, 'fourteen')
        self.assertRaises(pyxb_123.SimpleTypeValueError, CreateFromDocument, '<eString>fourteen</eString>')
    ...
    def testInteger (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, eInteger, 4)
        self.assertRaises(pyxb_123.SimpleTypeValueError, eInteger, '4')
        self.assertRaises(pyxb_123.SimpleTypeValueError, CreateFromDocument, '<eInteger>4</eInteger>')
        self.assertRaises(pyxb_123.SimpleTypeValueError, eInteger) # Value defaults to zero, not in enumeration
    ...
    def testDouble (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, eDouble, 2)
        self.assertRaises(pyxb_123.SimpleTypeValueError, eDouble, 2.0)
        self.assertRaises(pyxb_123.SimpleTypeValueError, eDouble, '2')
        self.assertRaises(pyxb_123.SimpleTypeValueError, eDouble, '2.0')
        self.assertRaises(pyxb_123.SimpleTypeValueError, CreateFromDocument, '<eDouble>2</eDouble>')
        self.assertRaises(pyxb_123.SimpleTypeValueError, CreateFromDocument, '<eDouble>2.0</eDouble>')
        self.assertRaises(pyxb_123.SimpleTypeValueError, eDouble) # Value defaults to zero, not in enumeration
    ...
    def testAny (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, eAny, 2)
        self.assertRaises(pyxb_123.SimpleTypeValueError, eAny, '2')
        self.assertRaises(pyxb_123.SimpleTypeValueError, CreateFromDocument, '<eAny>2</eAny>')
    ...
    def testList (self):
        ...
        self.assertEqual([1, 1, 2, 3], eListInt('1   1      2 3'))
        self.assertEqual([1, 1, 2, 3], CreateFromDocument('<eListInt>1    1       2 3</eListInt>'))
        self.assertRaises(pyxb_123.SimpleTypeValueError, eListInt, '1 2 3')
        self.assertRaises(pyxb_123.SimpleTypeValueError, eListInt, (1,2,3))

    def testListRestriction (self):
        self.assertTrue(9, len(justList([2] * 9)))
        self.assertTrue(10, len(justList([2] * 10)))
        self.assertRaises(pyxb_123.SimpleTypeValueError, justList, [2] * 11)
    ...
    def testJustUnion (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, eJustVarious, (1,2,3,5,8))

    def testUnion (self):
        self.assertEqual(tVarious.one, eVarious('one'))
        self.assertRaises(pyxb_123.SimpleTypeValueError, eVarious, 'two')
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, eVarious, '1.6')
        self.assertEqual([1,1,2,3], eVarious((1,1,2,3)))
        self.assertRaises(pyxb_123.SimpleTypeValueError, eVarious, (1,1,2,3,5,8))
