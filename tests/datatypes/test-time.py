...
class Test_time (unittest.TestCase):
    ...
    def testBad (self):
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.time, '12: 14: 32')
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.time, '12:14:32.Z')
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.time, '12:14:32.123405:00')
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.time, '12:14:32.1234+05')
