...
class Test_duration (unittest.TestCase):
    def testBasic (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.duration, 'P-1347M')
        v = xsd.duration('-P1347M')
        self.assertEqual(0, v.days)
        self.assertEqual(0, v.seconds)
        self.assertEqual(0, v.microseconds)
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.duration, 'P1Y2MT')
    ...
    def testCreation (self):
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.duration)
        self.assertRaises(pyxb_123.SimpleTypeValueError, xsd.duration, 4)
