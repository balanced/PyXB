...
class Test (unittest.TestCase):
    ...
    def testApp (self):
        ...
        xmlt = '<app:elt xmlns:app="urn:app" xmlns:common="urn:common"><common:base><common:bstr>hi</common:bstr></common:base><common:app><common:astr>there</common:astr></common:app></app:elt>'
