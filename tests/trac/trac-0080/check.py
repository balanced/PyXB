...
class TestTrac0080 (unittest.TestCase):
    ...
    def testType4 (self): # base
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, self.assignAttribute_, i4, self._NotANormalizedString)
    ...
    def testType3 (self): # restrict type
        ...
        self.assertFalse(au.required())
        #self.assertRaises(pyxb_123.SimpleTypeValueError, self.assignAttribute_, i3, self._NotAToken)
    ...
    def testType1 (self): # restrict type
        ...
        self.assertRaises(pyxb_123.SimpleTypeValueError, self.assignAttribute_, i1, self._NotAToken)
        self.assertRaises(pyxb_123.SimpleTypeValueError, self.assignAttribute_, i1, self._NotAnNCName)
    ...
    def testRoot (self): # restrict required
        ...
        self.assertRaises(pyxb_123.MissingAttributeError, r.validateBinding)
