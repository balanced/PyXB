...
class TestTrac_0069 (unittest.TestCase):
    def testMetaConstructor (self):
        ...
        xmlt = '<ns1:MetadataDocument xmlns:ns1="urn:trac-0069"><template>anewtemplate</template><timespan end="+INF" start="-INF"><field><name>name</name><value>fv0</value><value>fv1</value><value>fv2</value></field></timespan></ns1:MetadataDocument>'
