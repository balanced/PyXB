...
class TestAbstractElementError (unittest.TestCase):
    Good_xmlt = '<eCardinals><eConcCardCymru>un</eConcCardCymru><eConcCardEnglish>three</eConcCardEnglish></eCardinals>'
    Good_xmld = Good_xmlt.encode('utf-8')

    Bad_xmlt = '<eCardinals><eConcCardCymru>un</eConcCardCymru><eAbstractCard>three</eAbstractCard></eCardinals>'
...
class TestAbstractInstantiationError (unittest.TestCase):
    ...
    Good_xmlt = '<eUseAbstract xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><eAbstract xsi:type="tConcSubCymru"><welsh>un</welsh></eAbstract></eUseAbstract>'
    Good_xmld = Good_xmlt.encode('utf-8')

    Bad_xmlt = '<eUseAbstract xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><eAbstract><welsh>un</welsh></eAbstract></eUseAbstract>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestSimpleContentAbsentError (unittest.TestCase):
    ...
    Good_xmlt = '<eCTwSC>3</eCTwSC>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eCTwSC></eCTwSC>'
    Bad_xmld = Bad_xmlt.encode('utf-8')

    GoodSeq_xmlt = '<eCTwSCSequence><eCTwSC>1</eCTwSC><eCTwSC>2</eCTwSC></eCTwSCSequence>'
    GoodSeq_xmld = GoodSeq_xmlt.encode('utf-8')
    BadSeq_xmlt = '<eCTwSCSequence><eCTwSC>1</eCTwSC><eCTwSC></eCTwSC></eCTwSCSequence>'
...
class TestAttributeChangeError (unittest.TestCase):
    ...
    Good_xmlt = '<eAttributes aFixed="5" aReq="2"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eAttributes aFixed="2" aReq="2"/>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestAttributeValueError (unittest.TestCase):
    ...
    Good_xmlt = '<eAttributes aCardCymru="pedwar" aReq="4"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eAttributes aCardCymru="four" aReq="4"/>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestMissingAttributeError (unittest.TestCase):
    Good_xmlt = '<eAttributes aReq="4"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eAttributes/>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestProhibitedAttributeError (unittest.TestCase):
    Good_xmlt = '<eAttributes aProhibited="6" aReq="4"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eAttributesProhibited aProhibited="6" aReq="4"/>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestUnrecognizedAttributeError (unittest.TestCase):
    Good_xmlt = '<eAttributes aReq="4"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eAttributes aReq="4" aBad="1"/>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestAttributeOnSimpleTypeError (unittest.TestCase):
    Good_xmlt = '<eInts><eInt>1</eInt></eInts>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eInts><eInt bits="1">1</eInt></eInts>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestMixedContentError (unittest.TestCase):
    Good_xmlt = '<eCTwSCSequence><eCTwSC>2</eCTwSC></eCTwSCSequence>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eCTwSCSequence><eCTwSC>2</eCTwSC>noise</eCTwSCSequence>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestUnrecognizedContentError (unittest.TestCase):
    Good_xmlt = '<eInts><eInt>1</eInt></eInts>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eInts><eCTwSC>1</eCTwSC></eInts>'
...
\tA wildcard per trac26.xsd[84:8]'''
    Bad2_xmlt = '<eInts><something>1</something></eInts>'
...
class TestIncompleteElementContentError (unittest.TestCase):
    Good_xmlt = '<eTranslateCard><eConcCardCymru>un</eConcCardCymru><eConcCardEnglish>one</eConcCardEnglish><cardinal>1</cardinal></eTranslateCard>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eTranslateCard><eConcCardEnglish>one</eConcCardEnglish><cardinal>1</cardinal></eTranslateCard>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
\tcardinal (1 instances)'''
    ...
    def testException (self):
        ...
        (ed, syms) = next(iter(e.symbol_set.items()))
...
class TestContentInNilInstanceError (unittest.TestCase):
    Good_xmlt = '<eNilCTwSC xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"/>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eNilCTwSC xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true">4</eNilCTwSC>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestSimpleListValueError (unittest.TestCase):
    ...
    Good_xmlt = '<eListCardCymru>un dau tri pedwar</eListCardCymru>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eListCardCymru>un dau tri pedwar pump</eListCardCymru>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
...
class TestSimpleUnionValueError (unittest.TestCase):
    Good_xmlt = '<eSimpleInstance><eUnionCard>dau</eUnionCard></eSimpleInstance>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eSimpleInstance><eUnionCard>pump</eUnionCard></eSimpleInstance>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
    ...
    def testSchemaSupport (self):
        for (ty, va) in ((trac26.tCardCymru, 'un'), (trac26.tCardEnglish, 'two') , (xs.int, 3)):
            ...
            xmlt = '<eUnionCard>%s</eUnionCard>' % (va,)
...
class TestSimpleFacetValueError (unittest.TestCase):
    Good_xmlt = '<eTLA>ABC</eTLA>'
    Good_xmld = Good_xmlt.encode('utf-8')
    Bad_xmlt = '<eTLA>ABCD</eTLA>'
    Bad_xmld = Bad_xmlt.encode('utf-8')
