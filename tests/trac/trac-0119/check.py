...
pyxb_123.utils.domutils.BindingDOMSupport.DeclareNamespace(base.Namespace, 'base')
...
class TestTrac0119 (unittest.TestCase):
    ...
    def testRoundTrip (self):
        ...
        self.assertRaises(pyxb_123.SchemaValidationError, base.CreateFromDocument, xmld)
...
'''
        # Cannot resolve absent namespace in base module
        self.assertRaises(pyxb_123.SchemaValidationError, base.CreateFromDocument, xmlt)
        # Can resolve it in absent module
