...
import pyxb_123
import pyxb_123.xmlschema
from xml.dom import Node
import types
import re
import logging

import pyxb_123.namespace.archive
import pyxb_123.namespace.resolution

from pyxb_123.binding import basis
from pyxb_123.binding import datatypes
from pyxb_123.binding import facets
...
class _SchemaComponent_mixin (pyxb_123.namespace._ComponentDependency_mixin,
                              pyxb_123.namespace.archive._ArchivableObject_mixin,
                              pyxb_123.utils.utility.PrivateTransient_mixin,
                              pyxb_123.utils.utility.Locatable_mixin):
    ...
    def _namespaceContext (self):
        ...
        if self.__namespaceContext is None:
            raise pyxb_123.LogicError('Attempt to access missing namespace context for %s' % (self,))
    ...
    def __init__ (self, *args, **kw):
        ...
        if self.__namespaceContext is None:
            if node is None:
                raise pyxb_123.LogicError('Schema component constructor must be given namespace_context or node')
            self.__namespaceContext = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(node)
        if self.__namespaceContext is None:
            raise pyxb_123.LogicError('No namespace_context for schema component')
        ...
        if isinstance(node, pyxb_123.utils.utility.Locatable_mixin):
            self._setLocation(node._location())
        elif isinstance(owner, pyxb_123.utils.utility.Locatable_mixin):
    ...
    def _clone (self, owner, origin):
        ...
        if isinstance(self, pyxb_123.namespace.resolution._Resolvable_mixin):
        ...
        if isinstance(that, pyxb_123.namespace.resolution._Resolvable_mixin):
    ...
    def hasBinding (self):
        ...
        declarations have instances of L{pyxb_123.binding.basis.element} as their
        bindings."""
...
class _ParticleTree_mixin (pyxb_123.cscRoot):
...
class _Singleton_mixin (pyxb_123.cscRoot):
...
class _Annotated_mixin (pyxb_123.cscRoot):
...
class _PickledAnonymousReference (object):
    ...
    L{pyxb_123.namespace.ExpandedName} instance in that it can be used to
    dereference various component types."""

    __AnonymousCategory = pyxb_123.namespace.archive.NamespaceArchive._AnonymousCategory()
    ...
    def FromPickled (cls, object_reference):
        ...
        if not isinstance(object_reference, _PickledAnonymousReference):
            ...
            object_reference = pyxb_123.namespace.ExpandedName(object_reference)
    ...
    def __str__ (self):
        ...
        return 'ANONYMOUS:%s' % (pyxb_123.namespace.ExpandedName(self.__namespace, self.__anonymousName),)

class _NamedComponent_mixin (pyxb_123.utils.utility.PrivateTransient_mixin, pyxb_123.cscRoot):
    ...
    def _setAnonymousName (self, namespace, unique_id=None, anon_name=None):
        ...
        if anon_name is None:
            ...
            anon_name = pyxb_123.utils.utility.MakeUnique(anon_name, set(namespace.categoryMap(self.__AnonymousCategory).iterkeys()))
    ...
    def expandedName (self):
        """Return the L{pyxb_123.namespace.ExpandedName} of this object."""
        if self.name() is None:
            return None
        return pyxb_123.namespace.ExpandedName(self.targetNamespace(), self.name())
    ...
    def __new__ (cls, *args, **kw):
        ...
        see pyxb_123.namespace._XMLSchema.
        """
        ...
        if isinstance(scope, (tuple, _PickledAnonymousReference)):
            ...
            if scope_ctd is None:
                raise pyxb_123.SchemaValidationError('Unable to resolve local scope %s' % (scope_ref,))
            ...
            if rv is None:
                raise pyxb_123.SchemaValidationError('Unable to resolve %s as %s in scope %s' % (object_reference, icls, scope_ref))
            ...
            if rv is None:
                raise pyxb_123.SchemaValidationError('Unable to resolve %s as %s' % (object_reference, icls))
        if rv is None:
            raise pyxb_123.SchemaValidationError('Unable to resolve reference %s, scope %s ns %s type %s, class %s' % (object_reference, scope, (scope is None and "<unknown>" or scope.targetNamespace()), type(scope), icls))
        return rv
    ...
    def isNameEquivalent (self, other):
        ...
        pyxb_123.namespace.ExpandedName, for which None is not equivalent to any
        non-anonymous name."""
    ...
    def __pickleAsReference (self):
        ...
        pickling_archive = pyxb_123.namespace.archive.NamespaceArchive.PicklingArchive()
...
class _ValueConstraint_mixin (pyxb_123.cscRoot):
    ...
    def _valueConstraintFromDOM (self, node):
        ...
        if (adefault is not None) and (afixed is not None):
            raise pyxb_123.SchemaValidationError('Attributes default and fixed may not both appear (3.2.3r1)')
        if adefault is not None:
            if (ause is not None) and ('optional' != ause):
                raise pyxb_123.SchemaValidationError('Attribute use must be optional when default present (3.2.3r2)')
...
class _ScopedDeclaration_mixin (pyxb_123.cscRoot):
...
class _AttributeWildcard_mixin (pyxb_123.cscRoot):
    ...
    def _attributeRelevantChildren (self, node_list):
        ...
        @raise pyxb_123.SchemaValidationError: An C{attributeGroup} node is
        present but does not have the required C{ref} attribute.
        @raise pyxb_123.SchemaValidationError: Multiple C{anyAttribute} nodes are
        identified.
        """
        ...
        for node in node_list:
            ...
            if xsd.nodeIsNamed(node, 'attribute'):
                ...
                if agd_en is None:
                    raise pyxb_123.SchemaValidationError('Require ref attribute on internal attributeGroup elements')
                attribute_groups.append(agd_en)
            elif xsd.nodeIsNamed(node, 'anyAttribute'):
                if any_attribute is not None:
                    raise pyxb_123.SchemaValidationError('Multiple anyAttribute children are not allowed')
                any_attribute = node
    ...
    def CompleteWildcard (cls, namespace_context, attribute_groups, local_wildcard):
        ...
        @param namespace_context: The L{pyxb_123.namespace.NamespaceContext} to be
...
class AttributeDeclaration (_SchemaComponent_mixin, _NamedComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _Annotated_mixin, _ValueConstraint_mixin, _ScopedDeclaration_mixin):
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if xsd.nodeIsNamed(node.parentNode, 'schema'):
            ...
            raise pyxb_123.SchemaValidationError('Internal attribute declaration by reference')
    ...
    def _resolve (self):
        ...
        if self.__typeDefinition is None:
            raise pyxb_123.SchemaValidationError('Type reference %s cannot be found' % (self.__typeExpandedName,))
        if not isinstance(self.__typeDefinition, SimpleTypeDefinition):
            raise pyxb_123.SchemaValidationError('Need %s to be a simple type' % (self.__typeExpandedName,))
    ...
    def _updateFromOther_csc (self, other):
        ...
        if not other.isResolved():
            if pyxb_123.namespace.BuiltInObjectUID == self._objectOrigin().generationUID():
...
class AttributeUse (_SchemaComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _ValueConstraint_mixin):
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if use is not None:
            if 'required' == use:
                ...
                raise pyxb_123.SchemaValidationError('Unexpected value %s for attribute use attribute' % (use,))
    ...
    def _resolve (self):
        ...
        if self.__attributeDeclaration is None:
            raise pyxb_123.SchemaValidationError('Attribute declaration %s cannot be found' % (self.__refExpandedName,))
...
class ElementDeclaration (_ParticleTree_mixin, _SchemaComponent_mixin, _NamedComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _Annotated_mixin, _ValueConstraint_mixin, _ScopedDeclaration_mixin):
        ...
        if (type_definition is not None) and (self.valueConstraint() is not None):
            ...
            if failed:
                if self.__typeExpandedName is None:
                    raise pyxb_123.SchemaValidationError('Value constraint on element %s with non-simple content' % (self.expandedName(),))
                raise pyxb_123.SchemaValidationError('Value constraint on element %s with non-simple type %s' % (self.expandedName(), self.__typeExpandedName))
        return self
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if xsd.nodeIsNamed(node.parentNode, 'schema'):
            ...
            raise pyxb_123.SchemaValidationError('Created reference as element declaration')
        ...
        if rv.__typeExpandedName is not None:
            if (simpleType_node is not None) and (complexType_node is not None):
                raise pyxb_123.SchemaValidationError('Cannot combine type attribute with simpleType or complexType child')
            ...
            if rv.__typeExpandedName is None:
                ...
                for cn in node.childNodes:
                    if Particle.IsParticleNode(cn):
                        raise pyxb_123.SchemaValidationError('Node %s in element must be wrapped by complexType.' % (cn.localName,))
    ...
    def _resolve (self):
        ...
        if self.__substitutionGroupExpandedName is not None:
            ...
            if sga is None:
                raise pyxb_123.SchemaValidationError('Element declaration refers to unrecognized substitution group %s' % (self.__substitutionGroupExpandedName,))
        ...
        if self.__typeDefinition is None:
            ...
            if td is None:
                raise pyxb_123.SchemaValidationError('Type declaration %s cannot be found' % (self.__typeExpandedName,))
...
class ComplexTypeDefinition (_SchemaComponent_mixin, _NamedComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _Annotated_mixin, _AttributeWildcard_mixin):
    __PrivateTransient = set()
    ...
    def _recordLocalDeclaration (self, decl):
        ...
        if isinstance(decl, ElementDeclaration):
            ...
            raise pyxb_123.LogicError('Unexpected instance of %s recording as local declaration' % (type(decl),))
        ...
        if decl != existing_decl:
            if isinstance(decl, ElementDeclaration):
                ...
                if not pending_type.isDerivationConsistent(existing_type):
                    raise pyxb_123.SchemaValidationError('Conflicting element declarations for %s: existing %s versus new %s' % (decl.expandedName(), existing_type, pending_type))
            elif isinstance(decl, AttributeDeclaration):
                raise pyxb_123.SchemaValidationError('Multiple attribute declarations for %s' % (decl.expandedName(),))
            else:
    ...
    def contentTypeAsString (self):
        ...
        raise pyxb_123.LogicError('Unhandled content type')
    ...
    def UrTypeDefinition (cls, schema=None, in_builtin_definition=False):
        ...
        #    raise pyxb_123.LogicError('Multiple definitions of UrType')
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if not (rv._scopeIsGlobal() or rv.isAnonymous()):
            raise pyxb_123.LogicError('Attempt to create non-global complex type definition')
    ...
    def __completeProcessing (self, method, content_style):
        ...
        if self.__usesC1C2 is None:
            ...
            for ag_en in self.__attributeGroupNames:
                ...
                if agd is None:
                    raise pyxb_123.SchemaValidationError('Attribute group %s cannot be found' % (ag_en,))
        ...
        for au in self.__usesC1C2.union(uses_c3):
            ...
            if ad_en in use_map:
                raise pyxb_123.SchemaValidationError('Multiple definitions for %s in CTD %s' % (ad_en, self.expandedName()))
            use_map[ad_en] = au
    ...
    def __setComplexContentFromDOM (self, type_node, content_node, definition_node_list, method, **kw):
        ...
        ckw = kw.copy()
        ckw['namespace_context'] = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(type_node)
        ...
        for cn in definition_node_list:
            ...
            if xsd.nodeIsNamed(cn, 'simpleContent', 'complexContent'):
                ...
                raise pyxb_123.LogicError('Missed explicit wrapper in complexType content')
        ...
        if first_elt:
            ...
            if xsd.nodeIsNamed(first_elt, 'simpleContent'):
                ...
                if not Particle.IsParticleNode(first_elt, 'attributeGroup', 'attribute', 'anyAttribute'):
                    raise pyxb_123.SchemaValidationError('Unexpected element %s at root of complexType' % (first_elt.nodeName,))
            if have_content:
                ...
                if xsd.nodeIsNamed(ions, 'restriction'):
                    ...
                    raise pyxb_123.SchemaValidationError('Expected restriction or extension as sole child of %s in %s' % (content_node.nodeName, self.name()))
                self.__baseExpandedName = domutils.NodeAttributeQName(ions, 'base')
                if self.__baseExpandedName is None:
                    raise pyxb_123.SchemaValidationError('Element %s missing base attribute' % (ions.nodeName,))
    ...
    def _resolve (self):
        ...
        if self.__baseTypeDefinition is None:
            ...
            if base_type is None:
                raise pyxb_123.SchemaValidationError('Cannot locate %s: need import?' % (self.__baseExpandedName,))
...
class AttributeGroupDefinition (_SchemaComponent_mixin, _NamedComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _Annotated_mixin, _AttributeWildcard_mixin):
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if domutils.NodeAttribute(node, 'ref'):
            raise pyxb_123.SchemaValidationError('Attribute reference at top level')
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        for cn in node.childNodes:
            ...
            if Particle.IsParticleNode(cn):
                ...
                raise pyxb_123.SchemaValidationError('Unexpected element %s in model group' % (cn.nodeName,))
...
class Particle (_ParticleTree_mixin, _SchemaComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin):
    ...
    def __init__ (self, term, *args, **kw):
        ...
        if self.__maxOccurs is not None:
            if self.__minOccurs > self.__maxOccurs:
                raise pyxb_123.LogicError('Particle minOccurs %s is greater than maxOccurs %s on creation' % (min_occurs, max_occurs))
    ...
    def _resolve (self):
        ...
        if ModelGroup == self.__resolvableType:
            ...
            if group_decl is None:
                raise pyxb_123.SchemaValidationError('Model group reference %s cannot be found' % (self.__refExpandedName,))
            ...
            if self.__refExpandedName is not None:
                ...
                if self.__pendingTerm is None:
                    raise pyxb_123.SchemaValidationError('Unable to locate element referenced by %s' % (self.__refExpandedName,))
            assert self.__pendingTerm is not None
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if not Particle.IsParticleNode(node):
            raise pyxb_123.LogicError('Attempted to create particle from illegal element %s' % (node.nodeName,))
        ...
        if xsd.nodeIsNamed(node, 'group'):
            ...
            if rv.__refExpandedName is None:
                raise pyxb_123.SchemaValidationError('group particle without reference')
            ...
            if rv.__refExpandedName is None:
                ...
                for tag in ('nillable', 'default', 'fixed', 'form', 'block', 'type'):
                    ...
                    if av is not None:
                        raise pyxb_123.SchemaValidationError('element with "ref" cannot have "%s"' % (tag,))
            ...
            raise pyxb_123.LogicError('Unhandled node in Particle.CreateFromDOM: %s' % (node.toxml("utf-8"),))
...
class Wildcard (_ParticleTree_mixin, _SchemaComponent_mixin, _Annotated_mixin):
    ...
    def namespaceConstraint (self):
        ...
        L{Namespace<pyxb_123.namespace.Namespace>} instances, not the URIs that
    ...
    def IntensionalUnion (cls, constraints):
        ...
        while 0 < len(constraints):
            ...
            if negated_ns is not None:
                ...
                # 5.3
                if None in c_set:
                    raise pyxb_123.SchemaValidationError('Union of wildcard namespace constraints not expressible')
                o1 = c_tuple
                continue
            # 6
            if None in c_set:
        ...
        while 0 < len(constraints):
            ...
            if isinstance(o1, tuple) and isinstance(o2, tuple):
                ...
                if (ns1 is not None) and (ns2 is not None) and (ns1 != ns2):
                    raise pyxb_123.SchemaValidationError('Intersection of wildcard namespace constraints not expressible')
                # 6
    ...
    @classmethod
    def CreateFromDOM (cls, node, **kw):
        namespace_context = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(node)
            ...
            if cls.NC_any == nc:
                ...
                for ns_uri in nc.split():
                    if cls.NC_local == ns_uri:
                        ...
                        ncs.add(pyxb_123.namespace.NamespaceForURI(ns_uri, create_if_missing=True))
        ...
        if pc is None:
            ...
            if pc in [ cls.PC_skip, cls.PC_lax, cls.PC_strict ]:
                ...
                raise pyxb_123.SchemaValidationError('illegal value "%s" for any processContents attribute' % (pc,))
...
# 3.11.1
class IdentityConstraintDefinition (_SchemaComponent_mixin, _NamedComponent_mixin, _Annotated_mixin, pyxb_123.namespace.resolution._Resolvable_mixin):
    ...
    def CreateFromDOM (cls, node, **kw):
        ...
        if xsd.nodeIsNamed(node, 'key'):
            ...
            if rv.__referAttribute is None:
                raise pyxb_123.SchemaValidationError('Require refer attribute on keyref elements')
            rv.__isResolved = False
        elif xsd.nodeIsNamed(node, 'unique'):
            icc = rv.ICC_UNIQUE
        else:
            raise pyxb_123.LogicError('Unexpected identity constraint node %s' % (node.toxml("utf-8"),))
        rv.__icc = icc

        cn = domutils.LocateUniqueChild(node, 'selector')
        rv.__selector = domutils.NodeAttribute(cn, 'xpath')
        if rv.__selector is None:
            raise pyxb_123.SchemaValidationError('selector element missing xpath attribute')

        rv.__fields = []
        for cn in domutils.LocateMatchingChildren(node, 'field'):
            xp_attr = domutils.NodeAttribute(cn, 'xpath')
            if xp_attr is None:
                raise pyxb_123.SchemaValidationError('field element missing xpath attribute')
...
# Section 3.14.
class SimpleTypeDefinition (_SchemaComponent_mixin, _NamedComponent_mixin, pyxb_123.namespace.resolution._Resolvable_mixin, _Annotated_mixin):
    ...
    def primitiveTypeDefinition (self, throw_if_absent=True):
        if throw_if_absent:
            ...
            if self.__primitiveTypeDefinition is None:
                raise pyxb_123.LogicError('Expected primitive type for %s in %s', self, self.targetNamespace())
    ...
    def itemTypeDefinition (self):
        ...
        if self.__itemTypeDefinition is None:
            raise pyxb_123.LogicError('Expected item type')
    ...
    def memberTypeDefinitions (self):
        ...
        if self.__memberTypeDefinitions is None:
            raise pyxb_123.LogicError('Expected member types')
    ...
    def __str__ (self):
        ...
        if self.VARIETY_absent == self.variety():
            ...
            elts.append('?')
            #raise pyxb_123.LogicError('Unexpected variety %s' % (self.variety(),))
        if self.__facets:
            felts = []
    ...
    def SimpleUrTypeDefinition (cls, schema=None, in_builtin_definition=False):
        ...
        #    raise pyxb_123.LogicError('Multiple definitions of SimpleUrType')
    ...
    def _CreateXMLInstance (cls, name, schema):
        ...
        """
        from pyxb_123.binding import xml_
        kw = { 'schema' : schema,
               'binding_namespace' : schema.targetNamespace(),
               'namespace_context' : schema.targetNamespace().initialNamespaceContext(),
               'scope' : _ScopedDeclaration_mixin.SCOPE_global,
        ...
        if 'space' == name:
            ...
            raise pyxb_123.IncompleteImplementationError('No implementation for xml:%s' % (name,))
        bi.__facets = { }
    ...
    def CreateUnionInstance (cls, name, schema, member_stds):
        ...
        raise pyxb_123.IncompleteImplementationError('No support for built-in union types')
        ...
        for cn in body.childNodes:
            if (Node.ELEMENT_NODE == cn.nodeType):
                if not xsd.nodeIsNamed(cn, 'simpleType'):
                    if other_elts_ok:
                        continue
                    raise pyxb_123.SchemaValidationError('Context requires element to be xs:simpleType')
                assert not simple_type_child
                simple_type_child = cn
        if simple_type_child is None:
            raise pyxb_123.SchemaValidationError('Content requires an xs:simpleType member (or a base attribute)')
    ...
    def __initializeFromUnion (self, body, **kw):
        ...
        if mta is not None:
            nsc = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(body)
    ...
    def __processHasFacetAndProperty (self, variety):
        ...
        for ai in app_info:
            for cn in ai.childNodes:
                if Node.ELEMENT_NODE != cn.nodeType:
                    continue
                if pyxb_123.namespace.XMLSchema_hfp.nodeIsNamed(cn, 'hasFacet'):
                    facet_name = domutils.NodeAttribute(cn, 'name')# , pyxb_123.namespace.XMLSchema_hfp)
                    if facet_name is None:
                        raise pyxb_123.SchemaValidationError('hasFacet missing name attribute in %s' % (cn,))
                    if facet_name in seen_facets:
                        raise pyxb_123.SchemaValidationError('Multiple hasFacet specifications for %s' % (facet_name,))
                ...
                if pyxb_123.namespace.XMLSchema_hfp.nodeIsNamed(cn, 'hasProperty'):
        ...
        for fc in facets.Facet.Facets:
            ...
            if 0 < len(children):
                ...
                for cn in children:
                    ...
                    except pyxb_123.PyXBException as e:
                        raise pyxb_123.SchemaValidationError('Error assigning facet %s in %s: %s' % (fc.Name(), self.expandedName(), e))
                local_facets[fc] = fi
    ...
    def __completeResolution (self, body, variety, alternative):
        ...
        if self.__baseTypeDefinition is None:
            ...
            if not isinstance(base_type, SimpleTypeDefinition):
                raise pyxb_123.SchemaValidationError('Unable to locate base type %s' % (self.__baseExpandedName,))
            self.__baseTypeDefinition = base_type
        ...
        if self.VARIETY_absent == variety:
            ...
            if self._DA_list == alternative:
                if self.__itemTypeExpandedName is not None:
                    ...
                    if not isinstance(self.__itemTypeDefinition, SimpleTypeDefinition):
                        raise pyxb_123.SchemaValidationError('Unable to locate STD %s for items' % (self.__itemTypeExpandedName,))
            elif self._DA_restriction == alternative:
                self.__itemTypeDefinition = self.__baseTypeDefinition.__itemTypeDefinition
            else:
                raise pyxb_123.LogicError('completeResolution list variety with alternative %s' % (alternative,))
            ...
            if self._DA_union == alternative:
                ...
                if self.__memberTypeDefinitions is None:
                    ...
                    if self.__memberTypesExpandedNames is not None:
                        for mn_en in self.__memberTypesExpandedNames:
                            ...
                            if std is None:
                                raise pyxb_123.SchemaValidationError('Unable to locate member type %s' % (mn_en,))
                ...
                raise pyxb_123.LogicError('completeResolution union variety with alternative %s' % (alternative,))
            # Save a unique copy
            self.__memberTypeDefinitions = mtd[:]
        else:
            raise pyxb_123.LogicError('completeResolution with variety 0x%02x' % (variety,))
    ...
    def _resolve (self):
        ...
        if self.__baseTypeDefinition is None:
            raise pyxb_123.SchemaValidationError('xs:simpleType must have list, union, or restriction as child')
        ...
        if bad_instance:
            raise pyxb_123.SchemaValidationError('Expected exactly one of list, restriction, union as child of simpleType')
    ...
    def pythonSupport (self):
        if self.__pythonSupport is None:
            raise pyxb_123.LogicError('%s: No support defined' % (self.name(),))
        return self.__pythonSupport
...
class _ImportElementInformationItem (_Annotated_mixin):
    ...
    def namespace (self):
        """The L{pyxb_123.namespace.Namespace} instance corresponding to the value
    ...
    def schema (self):
        ...
        from a L{namespace archive<pyxb_123.namespace.NamespaceArchive>} in which
    ...
    def __init__ (self, importing_schema, node, **kw):
        ...
        if uri is None:
            raise pyxb_123.IncompleteImplementationError('import statements without namespace not supported')
        schema_location = pyxb_123.utils.utility.NormalizeLocation(domutils.NodeAttribute(node, 'schemaLocation'), importing_schema.location())
        self.__schemaLocation = schema_location
        ns = self.__namespace = pyxb_123.namespace.NamespaceForURI(uri, create_if_missing=True)
        ...
        if self.__schema is not None:
            if ns != self.__schema.targetNamespace():
                raise pyxb_123.SchemaValidationError('Import expected namespace %s but got %s' % (ns, self.__schema.targetNamespace()))
...
class Schema (_SchemaComponent_mixin):
    ...
    def __getstate__ (self):
        raise pyxb_123.LogicError('Attempt to serialize Schema instance')
    ...
    __attributeMap = { pyxb_123.namespace.ExpandedName(None, 'attributeFormDefault') : _UNQUALIFIED
                     , pyxb_123.namespace.ExpandedName(None, 'elementFormDefault') : _UNQUALIFIED
                     , pyxb_123.namespace.ExpandedName(None, 'blockDefault') : ''
                     , pyxb_123.namespace.ExpandedName(None, 'finalDefault') : ''
                     , pyxb_123.namespace.ExpandedName(None, 'id') : None
                     , pyxb_123.namespace.ExpandedName(None, 'targetNamespace') : None
                     , pyxb_123.namespace.ExpandedName(None, 'version') : None
                     , pyxb_123.namespace.XML.createExpandedName('lang') : None
                     }

    def _setAttributeFromDOM (self, attr):
        """Override the schema attribute with the given DOM value."""
        self.__attributeMap[pyxb_123.namespace.ExpandedName(attr.name)] = attr.nodeValue
        return self
    ...
    def schemaHasAttribute (self, attr_name):
        ...
        if isinstance(attr_name, basestring):
            attr_name = pyxb_123.namespace.ExpandedName(None, attr_name)
    ...
    def __init__ (self, *args, **kw):
        ...
        if not kw.get('_bypass_preload', False):
            pyxb_123.namespace.archive.NamespaceArchive.PreLoadArchives()
        ...
        if not isinstance(self.__targetNamespace, pyxb_123.namespace.Namespace):
            raise pyxb_123.LogicError('Schema constructor requires valid Namespace instance as target_namespace')

        # NB: This will raise pyxb_123.SchemaUniquenessError if it appears this
    ...
    def CreateFromDocument (cls, xmls, **kw):
        if not ('schema_signature' in kw):
            kw['schema_signature'] = pyxb_123.utils.utility.HashForText(xmls)
    ...
    def CreateFromLocation (cls, **kw):
        ...
        L{normallzed<pyxb_123.utils.utility.NormalizeLocation>}.
        ...
        """
        schema_location = kw.pop('absolute_schema_location', pyxb_123.utils.utility.NormalizeLocation(kw.get('schema_location'), kw.get('parent_uri'), kw.get('prefix_map')))
        ...
        return cls.CreateFromDocument(pyxb_123.utils.utility.DataFromURI(schema_location, archive_directory=uri_content_archive_directory), **kw)
    ...
    def CreateFromDOM (cls, node, namespace_context=None, schema_location=None, schema_signature=None, generation_uid=None, **kw):
        ...
        if Node.ELEMENT_NODE != root_node.nodeType:
            raise pyxb_123.LogicError('Must be given a DOM node of type ELEMENT')

        assert (namespace_context is None) or isinstance(namespace_context, pyxb_123.namespace.resolution.NamespaceContext)
        ns_ctx = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(root_node,
                                                                           parent_context=namespace_context,
                                                                           including_context=including_context)

        tns = ns_ctx.targetNamespace()
        if tns is None:
            raise pyxb_123.SchemaValidationError('No targetNamespace associated with content (not a schema?)')
        ...
        if schema.targetNamespace() != ns_ctx.targetNamespace():
            raise pyxb_123.SchemaValidationError('targetNamespace %s conflicts with %s' % (schema.targetNamespace(), ns_ctx.targetNamespace()))
        ...
        if not xsd.nodeIsNamed(root_node, 'schema'):
            raise pyxb_123.SchemaValidationError('Root node %s of document is not an XML schema element' % (root_node.nodeName,))
    ...
    def targetNamespaceForNode (self, dom_node, declaration_type):
        ...
        @return: L{pyxb_123.namespace.Namespace} or None
        """
        ...
        if form_type is None:
            if declaration_type == ElementDeclaration:
                ...
                raise pyxb_123.LogicError('Expected ElementDeclaration or AttributeDeclaration: got %s' % (declaration_type,))
        tns = None
        if (self._QUALIFIED == form_type):
            ...
            if (self._UNQUALIFIED != form_type):
                raise pyxb_123.SchemaValidationError('Form type neither %s nor %s' % (self._QUALIFIED, self._UNQUALIFIED))
        return tns
    ...
    def __requireInProlog (self, node_name):
        ...
        if self.__pastProlog:
            raise pyxb_123.SchemaValidationError('Unexpected node %s after prolog' % (node_name,))

    def __processInclude (self, node):
        self.__requireInProlog(node.nodeName)
        # See section 4.2.1 of Structures.
        abs_uri = pyxb_123.utils.utility.NormalizeLocation(domutils.NodeAttribute(node, 'schemaLocation'), self.__location)
        ...
        if schema_instance:
            if self.targetNamespace() != schema_instance.targetNamespace():
                raise pyxb_123.SchemaValidationError('Included namespace %s not consistent with including namespace %s' % (schema_instance.targetNamespace(), self.targetNamespace()))
    ...
    def __processRedefine (self, node):
        self.__requireInProlog(node.nodeName)
        raise pyxb_123.IncompleteImplementationError('redefine not implemented')
    ...
    def __processTopLevelNode (self, node):
        ...
        raise pyxb_123.SchemaValidationError('Unexpected top-level element %s' % (node.nodeName,))
    ...
    def _addNamedComponent (self, nc):
        ...
        if not isinstance(nc, _NamedComponent_mixin):
            raise pyxb_123.LogicError('Attempt to add unnamed %s instance to dictionary' % (nc.__class__,))
        if nc.isAnonymous():
            raise pyxb_123.LogicError('Attempt to add anonymous component to dictionary: %s', (nc.__class__,))
    ...
    def __addTypeDefinition (self, td):
        ...
        if (old_td is not None) and (old_td != td):
            if isinstance(td, ComplexTypeDefinition) != isinstance(old_td, ComplexTypeDefinition):
                raise pyxb_123.SchemaValidationError('Name %s used for both simple and complex types' % (td.name(),))

            if not old_td._allowUpdateFromOther(td):
                raise pyxb_123.SchemaValidationError('Attempt to re-define non-builtin type definition %s' % (tns.createExpandedName(local_name),))
    ...
    def __addAttributeDeclaration (self, ad):
        ...
        if (old_ad is not None) and (old_ad != ad):
            if not old_ad._allowUpdateFromOther(ad):
                raise pyxb_123.SchemaValidationError('Attempt to re-define non-builtin attribute declaration %s' % (tns.createExpandedName(local_name),))
    ...
    def __addAttributeGroupDefinition (self, agd):
        ...
        if (old_agd is not None) and (old_agd != agd):
            if not old_agd._allowUpdateFromOther(agd):
                raise pyxb_123.SchemaValidationError('Attempt to re-define non-builtin attribute group definition %s' % (tns.createExpandedName(local_name),))
...
def _AddSimpleTypes (namespace):
    ...
    This should only be invoked by L{pyxb_123.namespace} when the built-in
    namespaces are initialized. """
    # Add the ur type
    #schema = namespace.schema()
    schema = Schema(namespace_context=pyxb_123.namespace.XMLSchema.initialNamespaceContext(), schema_location='URN:noLocation:PyXB:XMLSchema', generation_uid=pyxb_123.namespace.BuiltInObjectUID, _bypass_preload=True)
...
import sys
import pyxb_123.namespace.builtin
pyxb_123.namespace.builtin._InitializeBuiltinNamespaces(sys.modules[__name__])
