...
from pyxb_123.bundles.wssplat.raw.wsdl11 import *
import pyxb_123.bundles.wssplat.raw.wsdl11 as raw_wsdl11
...
def ImportRelatedNamespaces ():
    ...
    try:
        import pyxb_123.bundles.wssplat.soapbind11
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.soapbind12
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.soap11
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.soap12
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.soapenv
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.httpbind
    except ImportError:
        pass
    try:
        import pyxb_123.bundles.wssplat.mimebind
    except ImportError:
        pass
...
class tDefinitions (raw_wsdl11.tDefinitions):
    ...
    def _postFactory_vx (self, state):
        ...
        node_en = pyxb_123.namespace.ExpandedName(dom_node)
        self.__namespaceContext = pyxb_123.namespace.resolution.NamespaceContext.GetNodeContext(dom_node)
        self.__buildMaps()
        if process_schema:
    ...
    def __processSchema (self, generation_uid):
        ...
        for t in self.types:
            for wc in t.wildcardElements():
                if isinstance(wc, xml.dom.Node) and pyxb_123.namespace.XMLSchema.nodeIsNamed(wc, 'schema'):
                    ...
                    self.__schema = pyxb_123.xmlschema.schema.CreateFromDOM(wc, namespace_context=self.namespaceContext(), generation_uid=generation_uid)
                elif isinstance(wc, pyxb_123.xmlschema.schema):
                    self.__schema = wc
                else:
...
pyxb_123.namespace.resolution.NamespaceContext._AddTargetNamespaceAttribute(raw_wsdl11.Namespace.createExpandedName('definitions'), pyxb_123.namespace.ExpandedName('targetNamespace'))
